# AI Usage Recap per Team Member

**Rohan** 
- AI used predominantly to support the creation of the slimemold.py. Extensive pseudo-code written, which then github copilot turned into a numpy algorithm, leaving doc comments including some of the original pseudocode. 
...
- Cursor/Copilot were used also for documentation